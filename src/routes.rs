...
use crate::handlers::{create_example_handler, create_word_handler, delete_example_handler, delete_word_handler, health_checker_handler, update_word_handler};
...
pub fn create_router(app_state: Arc<AppState>) -> Router {
    Router::new()
        ...
        .route("/api/vocab/:word_id", put(update_word_handler))
